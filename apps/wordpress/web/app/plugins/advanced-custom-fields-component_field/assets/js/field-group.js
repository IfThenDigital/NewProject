(function($, undefined) {
  ...
  var hasChanged = function(field) {
    ...
    acf.getFieldObjects({ parent: field.$el }).map(function(field) {
  ...
  var getFieldElement = function(object) {
    return object.$el
      ...
      : object.data("type")
      ? object
      : object.closest(".acf-field-object");
  };

  var canBeConverted = function(object) {
    return inArray(getFieldElement(object).data("type"), [
      "repeater",
      "component_field"
    ]);
  };
  ...
  var addConvertButton = function($el) {
    ...
    jQuery(
      '<a class="convert-field" title="' +
        acf.__("convert_title") +
        '" href="#" style="margin-left: 3px;">' +
        acf.__("convert_text") +
        "</a>"
  ...
  var disableCurrentGroupFromComponentSelect = function(field) {
    var fieldObjectKey = field.$el
      .closest(".acf-field-object")
      .attr("data-key");

    field.$el
      .find('option[value="' + fieldObjectKey + '"]')
      .prop("disabled", true);
  };
  ...
  var loadComponentSettings = function(field) {
    ...
    var $settingFields = field.$el.siblings(
      '[data-setting="' + fieldType + '"]'
    );
    field.set(
      "component_group-" + field.get("field_group_key"),
      $settingFields
    );
  ...
  $(document).on(
    "change.adjust_acf_metabox",
    "#is_acf_component_checkbox",
    function(e) {
      if ($(this).is(":checked")) {
  ...
  acf.addAction("append", function($el) {
    ...
    canBeConverted($fieldObject)
      ? addConvertButton($fieldObject)
      : removeConvertButton($fieldObject);
  });
  ...
  acf.FieldObject.prototype.onConvert = function() {
    ...
    var convertFields = function(e) {
      ...
      var deleteComponent =
        popup.$('input[name="delete-component"]:checked').length > 0;
